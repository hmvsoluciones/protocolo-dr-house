        ...
        <div class="x_panel" style="height:600px;">
            ...
            <form class="form-inline">
                <div class="form-group mx-sm-3 mb-2">
                    ...
                    <input type="text" readonly name="binnacleDate" size="10"  id="binnacleDate" placeholder="">
                </div>
                <div class="form-group mx-sm-3 mb-2">
                ...
                <div class="form-group mx-sm-3 mb-2">
                    ...
                    <select class="form-control" name="operation" id="operation"></select>
                </div>
                <div class="form-group mx-sm-3 mb-2">
                    <label for="usuario">User</label>
                    <select class="form-control" name="user" id="user"></select>
                </div>
                <span class="fa fa-search iconSuccess" data-toggle="modal" data-target="#modalAdd" onclick="addNew()"></span>
            </form>
